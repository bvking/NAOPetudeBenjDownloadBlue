...
if (measure > 60 && measure < 78 && millis() > formerEvent[73] + 0 + d + 150 &&
    ((note1 == 72 + 1 && velocity1 != 0) || (note2 == 72 + 1 && velocity2 != 0) || (note3 == 72 + 1 && velocity3 != 0) ||
    (note4 == 72 + 1 && velocity4 != 0) || (note5 == 72 + 1 && velocity5 != 0) || (note6 == 72 + 1 && velocity6 != 0))) {
  keyReleased();
...
if (measure < 78 && millis() > formerEvent[75] + 0 + d &&
    ((note1 == 73 + 1 && velocity1 != 0) || (note2 == 73 + 1 && velocity2 != 0) || (note3 == 73 + 1 && velocity2 != 0) ||
    (note4 == 73 + 1 && velocity4 != 0) || (note5 == 73 + 1 && velocity5 != 0) || (note6 == 73 + 1 && velocity6 != 0))) {
  key = 'k';
  keyReleased();
