...
String positionMov;
void trigEventWithAbletonSignalGood() {  // change de sens de propagagtion.   ATTENTION dans ce reglage le signalToSplit de propgation est UP continue de 0 à TWO_PI
    ...
    if (  positionMov == " premierePartie "){ 
     ...
     textSize (50);
      ...
      for (int i = 0; i < networkSize-0; i++) {  
       ...
       text  ( " oscillatorBlocked " + oscillatorBlocked + " memoryi " + memoryi + " frequency " + i + " "  + net.naturalFrequency[i], -1500 , 500 +(i*50));
       } 
