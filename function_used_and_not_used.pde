...
void recordFrame() { 
  ...
  if (key == '@' || keyCode == ESC) {
    ...
    key = '9'; // aligne les ballee
     for (int i = 0; i < networkSize; i++)  {
     // dataToControlStepMotorisedPosition[i]=0;
...
void sendToTeensy() {
  ...
  String dataMarkedToTeensyJoGood  ="<" // BPM9   
   ...
   // +   dataToControlStepMotorisedPosition[6]+","+( dataToControlStepMotorisedPosition[5])+","+dataToControlStepMotorisedPosition[4]+","+dataToControlStepMotorisedPosition[3]+","+dataToControlStepMotorisedPosition[2]+","//dataToControlStepMotorisedPosition[2]
...
void sendToTeensyTurnOnDriver() {
  ...
  String dataMarkedToTeensyJoGood  ="<" // BPM9   
   ...
   // +   dataToControlStepMotorisedPosition[6]+","
    ...
    +( dataToControlStepMotorisedPosition[5])+","+dataToControlStepMotorisedPosition[4]+","+dataToControlStepMotorisedPosition[3]+","+dataToControlStepMotorisedPosition[2]+","//dataToControlStepMotorisedPosition[2]
...
//    LFO[oscillatorChange] =  LFO[oscillatorChange]%TWO_PI; 
 ...
 //   dataToControlStepMotorisedPosition[i]= (int) newPosF[i];
       }
 ...
 //   dataToControlStepMotorisedPosition[i]= (int) newPosF[i];
  ...
  for (int i = 2; i < networkSize; i++) { 
    ...
    dataToControlStepMotorisedPosition[i]= (int) dataToChange[i];// newPosF[i];
   }  
 */
